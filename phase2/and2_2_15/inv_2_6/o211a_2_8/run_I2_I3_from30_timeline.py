#!/usr/bin/env python3
"""Timeline: 2-I / 3-I spacing starting near cyc 30 (o211a_2_8).

Same I patterns as inv_2_6/run_I2_I3_from30_timeline.py.
...
def main() -> None:
    ...
    fig.suptitle(
        f"o211a_2_8 · 2-I & 3-I spacing from I_REF={I_REF}",
        fontsize=11,
    )
    fig.tight_layout()
    png = savefig_locked(fig, OUT / "I2_I3_from30.png")

    md = [
        f"# `o211a_2_8` — 2-I / 3-I spacing from cyc {I_REF}",
        "",
        f"Same I patterns as [`../../timelines/I2_I3_from30.md`](../../timelines/I2_I3_from30.md).",
        "",
        "```text",
