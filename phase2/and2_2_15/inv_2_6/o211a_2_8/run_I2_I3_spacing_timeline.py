#!/usr/bin/env python3
"""Timeline: 2-I / 3-I spacing sweep in first 14 cycles (o211a_2_8).

Same I patterns as inv_2_6/run_I2_I3_spacing_timeline.py; lanes are
...
def main() -> None:
    ...
    for ax, (name, _) in zip(axes, modes):
        ...
        n_noi = len(NOI_LANES)
        ax.axhline(len(DISPLAY) - n_noi - 0.5, color="#999", lw=0.8, ls="--", zorder=0)
    ...
    fig.suptitle(
        "o211a_2_8 · 2-I & 3-I spacing in first 14 cycles (I_REF=1) · NO-I stubs on top",
        fontsize=11,
    )
    fig.tight_layout()
    ...
    md = [
        ...
        "",
        f"Same I patterns as [`../../timelines/I2_I3_spacing.md`](../../timelines/I2_I3_spacing.md).",
        "",
