#!/usr/bin/env python3
"""Timeline: 2-I / 3-I spacing starting near cyc 75 (o211a_2_8).

Same I patterns as inv_2_6/run_I2_I3_from75_timeline.py.
...
def main() -> None:
    ...
    md = [
        ...
        "",
        f"Same I patterns as [`../../timelines/I2_I3_from75.md`](../../timelines/I2_I3_from75.md).",
        "",
        "```text",
